...
val iter_record_ClassAxiom : (ClassAxiom.t -> unit) -> t -> unit
...
val count_ObjectInverseOf : t -> Polarity.Counter.t
val total_ObjectInverseOf : t -> int
...
val print_info : t -> out_channel -> unit
