...
val fprint_ontology : ?message:string -> Progress_tracker.t -> 
	Format.formatter -> Ontology.t -> unit
val print_ontology_ch : ?message:string -> Progress_tracker.t -> 
	Ontology.t -> out_channel -> unit
val save_ontology : ?message:string -> Progress_tracker.t ->
